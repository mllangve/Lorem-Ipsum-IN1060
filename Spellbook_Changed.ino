...
//ARRAYS
int lysRad1 [] = {rad1Lys1, rad1Lys2, rad1Lys3, rad1Lys4, rad1Lys5};                                                          //Holder alle LED-lysene på rad 1
int lysRad2 [] = {rad2Lys1, rad2Lys2, rad2Lys3, rad2Lys4, rad2Lys5};                                                          //Holder alle LED-lysene på rad 2
...
void pluss(int lysRad[], int antLysPaa){                                                            //Registrer hvilken lysrad og hvilken teller man ønsker å bruke som argumenter                                                      
      ...
      for(int i = lysRad.len; i <= 0; i++){                                          //for(int i = 0; i <= 5; i ++){
        if (i <= antLysPaa){
